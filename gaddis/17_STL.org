...
- Containers are C++ "template" implementations of important data
  structures. We'll cover five of these in detail.
...
We're not going to cover these.
...
To work with these containers, you need to included the necessary header files:
